package noobanidus.mods.twilightlootr.client.item;
...
public class TFLootrBossChestItemRenderer extends BlockEntityWithoutLevelRenderer {
  private static TFLootrBossChestItemRenderer INSTANCE = null;

  private final BlockEntityRenderDispatcher blockEntityRenderDispatcher;
  private final TFLootrBossChestBlockEntity blockEntity;

  public TFLootrBossChestItemRenderer(BlockEntityRenderDispatcher pBlockEntityRenderDispatcher, EntityModelSet pEntityModelSet) {
    super(pBlockEntityRenderDispatcher, pEntityModelSet);
    this.blockEntityRenderDispatcher = pBlockEntityRenderDispatcher;
    this.blockEntity = new TFLootrBossChestBlockEntity(BlockPos.ZERO, ModBlocks.BOSS_CHEST.value().defaultBlockState());
  }

  public TFLootrBossChestItemRenderer() {
    this(Minecraft.getInstance().getBlockEntityRenderDispatcher(), Minecraft.getInstance().getEntityModels());
  }

  public static TFLootrBossChestItemRenderer getInstance() {
    if (INSTANCE == null) {
      INSTANCE = new TFLootrBossChestItemRenderer();
    }
